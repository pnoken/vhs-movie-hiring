...
const SignupForm = () => {
  ...
  const onSubmit = (
    data = { first_name, last_name, username, email, password, age },
  ) => {
    ...
    axios
      ...
      .catch(err => {
        ...
        // console.log(resp.data);
        window.location = '#';
        notify().error('We could not sign you up, kindly try again later.');
      });
    console.log(data);
  };
  ...
  console.log(
    watch('firstname', 'lastname', 'username', 'email', 'age', 'password'),
  );
  console.log(
    errors.firstname,
    errors.lastname,
        ...
        <div className={styles.loginCard}>
          ...
          <div className={styles.form}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              {/*Input Error messgae*/}
              {errors.age && (
                <span className={styles.errors}>Kindly enter your age</span>
              )}
              {/*Input for password*/}
              <input
                type="password"
